...
def main(args):
    ...
    #load from pretrained args.path
    model = VisionEncoderDecoderModel.from_pretrained(args.path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", type=str, default="Image_Captioning_VIT_Roberta_final_3")
